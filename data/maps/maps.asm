...
MapGroup_Cianwood:
	...
	map GateHouse, TILESET_GATE, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Sandalwood:	
	table_width MAP_LENGTH, MapGroup_Sandalwood
	map SandalwoodTown, TILESET_JOHTO_MODERN, TOWN, LANDMARK_SANDALWOOD_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_SANDALWOOD_MAPS	
